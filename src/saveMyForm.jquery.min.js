...
a.extend(c.prototype,{init:function(){var b=this;this._elementList=this.getElementList(),a(this.element).find(':input').each(function(){b.addElement(this)}),this.storeElementList(),!0===this.settings.resetOnSubmit&&a(this.element).submit(function(){b.clearStorage()})},addElement:function(b){if(!a(b).is(this.settings.exclude)&&(null===this.settings.include||a(b).is(this.settings.include))){var c=this,d=this.getName(b);d&&(a(b).change(function(a){c.storeElement(a)}).keyup(debounce(function(a){c.storeElement(a)},500)),void 0===this._loadingList[d]?this._loadingList[d]=0:!a(b).is(':radio')&&(this._loadingList[d]++,a.data(b,'multiple',this._loadingList[d]),d=d+this.settings.sameNameSeparator+this._loadingList[d]),-1===this._elementList.indexOf(d)&&this._elementList.push(d),!0===this.settings.loadInputs&&this.loadElement(b))}},loadElement:function(b){var c=this.getName(b),d=localStorage.getItem(c);null!==d&&(d=JSON.parse(d),a(b).is(':checkbox')?a(b).prop('checked',d).change():a(b).is(':radio')?d==a(b).val()&&a(b).prop('checked',!0).change():a(b).val(d).change())},storeElement:function(b){var c,d=this.getName(b.target),e=a(b.target);d&&(c=a(b.target).is(':checkbox')?e.prop('checked'):e.val(),localStorage.setItem(d,JSON.stringify(c)))},getElementList:function(){return a.fn.saveMyForm.getElementListByFormName(this._formName)},storeElementList:function(){localStorage.setItem('elementList_'+this._formName,JSON.stringify(this._elementList))},clearElementList:function(){localStorage.removeItem('elementList_'+this._formName)},clearStorage:function(){a.fn.saveMyForm.clearStorageByFormName(this._formName)},getName:function(b){var c=a(b),d=c.attr('name')===void 0?c.attr('id')===void 0?void 0:c.attr('id'):c.attr('name');// Set by name first to allow radio groups to function, then id
